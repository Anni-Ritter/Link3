...
namespace Link
{
    public class FirstThreadSend
    {
        private Semaphore _sendSemaphore;
        private Semaphore _receiveSemaphore;
        private PostToFirstRecieveWT _post;
        private BitArray _receivedMessage;
        private readonly Random random = new Random();


        public FirstThreadSend(ref Semaphore sendSemaphore, ref Semaphore receiveSemaphore)
        {
        ...
        {
            _post = (PostToFirstRecieveWT)obj;
